...
enum test_spawn_config_echo_payloads {
...
#define MODULE_PATH "../test_modules/config_echo.elf"

#define MODULE_HASH                                                           \
	"9916ad2473beb308a6fd114fa2de03837d78f85443c2fb9af5139fd7eeb5ecac"
...
void
test_spawn_mod_config_echo(void **state)
{
	// start agent
...
main(void)
{
	...
	const struct CMUnitTest tests[] = {
		cmocka_unit_test(test_spawn_mod_config_echo),
	};
