...
void
test_wasm_mod_config_echo_early(void **state)
{
	// start agent
	...
	agent_ensure_deployment_config(
		&d, agent_get_payload(DEPLOYMENT_MANIFEST_1),
		TEST_DEPLOYMENT_ID1, agent_get_payload(INSTANCE_CONFIG_1));
...
main(void)
{
	...
	const struct CMUnitTest tests[] = {
		cmocka_unit_test(test_wasm_mod_config_echo_early),
	};
