...
#define MODULE_PATH "../test_modules/python/rpc.zip"

#define MODULE_HASH                                                           \
	"cdb5d68fd12d09ebf9d8728879d4f6489b81ba6016f6abd52bc1259127592f1b"
...
static void
test_python_mod_mdc(void **state)
{
...
main(void)
{
	...
	const struct CMUnitTest tests[] = {
		cmocka_unit_test(test_python_mod_mdc),
	};
	// setup and run tests
